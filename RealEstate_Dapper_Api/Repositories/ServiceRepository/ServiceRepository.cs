...
namespace RealEstate_Dapper_Api.Repositories.ServiceRepository
{
    public class ServiceRepository : IServiceRepository
    {
        ...
        {
            string query = "insert into Tbl_Services (ServiceName,ServiceStatus ) values (@serviceName,@serviceStatus)";
        ...
        {
            string query = "Delete From Tbl_Services Where ServiceID=@serviceID";
            var parameters = new DynamicParameters();
        ...
        {
            string query = "Select * From Tbl_Services Where ServiceID=@serviceID";
            var parameters = new DynamicParameters();
            parameters.Add("@serviceID", id);
            using (var connection = _context.CreateConnection())
            {
        ...
        {
            string query = "Update Tbl_Services Set ServiceName=@serviceName,ServiceStatus=@serviceStatus WHERE ServiceID=@serviceID";
            var parameters = new DynamicParameters();
