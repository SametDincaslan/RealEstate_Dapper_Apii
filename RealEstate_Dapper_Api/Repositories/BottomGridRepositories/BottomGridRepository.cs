...
namespace RealEstate_Dapper_Api.Repositories.BottomGridRepositories
{
    public class BottomGridRepository : IBottomGridRepository
    {
        ...
        {
            string query = "insert into Tbl_BottomGrid (BottomGridIcon,BottomGridTitle,BottomGridDescription) values (@bottomGridIcon,@bottomGridTitle,@bottomGridDescription)";
        ...
        public async void UpdateBottomGrid(UpdateBottomGridDto updateBottomGridDto)
        {
            ...
            string query = "Update Tbl_BottomGrid Set BottomGridIcon=@bottomGridIcon,BottomGridTitle=@bottomGridTitle ,BottomGridDescription=@bottomGridDescription WHERE BottomGridID=@bottomGridID";
            var parameters = new DynamicParameters();
