...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client1.GetAsync("https://localhost:44375/api/Statistics/ActiveCategoryCount");
            ...
            var responseMessage4 = await client4.GetAsync("https://localhost:44375/api/Statistics/AverageProductPriceRent");
            var jsonData4=await responseMessage4.Content.ReadAsStringAsync();
            ViewBag.averageProductPriceRent = jsonData4;
            #endregion
            
            #region İstatistik5
            var client5 =_httpClientFactory.CreateClient();
            var responseMessage5 = await client5.GetAsync("https://localhost:44375/api/Statistics/AverageProductPriceSale");
            var jsonData5=await responseMessage5.Content.ReadAsStringAsync();
            ViewBag.averageProductPriceSale= jsonData5;
            #endregion
            ...
            var responseMessage13 = await client13.GetAsync("https://localhost:44375/api/Statistics/NewstBuildingYear");
            var jsonData13=await responseMessage13.Content.ReadAsStringAsync();
            ViewBag.newstBuildingYear = jsonData13;
            #endregion
            
            #region İstatistik14
            var client14 =_httpClientFactory.CreateClient();
            var responseMessage14 = await client14.GetAsync("https://localhost:44375/api/Statistics/OldersBuildingYear");
            var jsonData14=await responseMessage14.Content.ReadAsStringAsync();
            ViewBag.oldersBuildingYear = jsonData14;
            #endregion
